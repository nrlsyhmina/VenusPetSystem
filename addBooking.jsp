                    ...
                    <div class="row">
                        ...
                        <div class="col mb-4">
                            ...
                            <div class="card shadow mb-4">
			                    ...
			                    <input type="text" class="form-control form-control-user" name="custID"  title="Name should only contain letters,@,',- . e.g. john" placeholder="CUSTOMER'S NAME" required>
			                  </div>
			                  <div class="form-group">
			                  ...
			                  <div class="form-group">
			                    <input type="number" class="form-control form-control-user" name="bTotalPrice"   placeholder="Total Price" readonly>
			                  </div>
