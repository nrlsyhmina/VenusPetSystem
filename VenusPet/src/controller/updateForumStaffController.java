 ...
 */
@WebServlet("/updateForumStaffController")
public class updateForumStaffController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       private forumDAO dao;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updateForumStaffController() {
        dao = new forumDAO();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = request.getRequestDispatcher("staff-update-forum.jsp");
