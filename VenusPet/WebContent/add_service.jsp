                        ...
                        <div class="col mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="form-group">
                                    <input type="hidden" class="form-control form-control-user" id="serviceID"
                                ...
                                <div class="form-group">
                                    <input type="number" class="form-control form-control-user" id="svPrice"
                                        placeholder="Price">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="svDescription"
                                        placeholder="Description">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="staffID"
