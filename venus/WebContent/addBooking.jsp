                    ...
                    <div class="row">
                        ...
                        <div class="col mb-4">
                            ...
                            <div class="card shadow mb-4">
                               ...
                               <div class="form-group">
			                    <input type="text" class="form-control form-control-user" name="custID" maxlength="12" placeholder="customer" value="${customer.cName}"  required>
			                  </div>
			                  <div class="form-group">
			                  ...
			                  <div class="form-group">
			                    <input type="hidden" class="form-control form-control-user" name="staffID" maxlength="12" placeholder="staff" value="${customer.cName}"  required>
			                  </div>
